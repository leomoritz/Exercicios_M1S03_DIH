...
public class ProgramaPrincipal {
	...
	public static void main(String[] args) {
		...
		Usuario usuario1 = new Usuario("João Silva", "Rua A", "05/02/1995");
		...
		Usuario usuario8 = new Usuario("Leônidas Rosa", "Rua G", "17/02/1995",
		...
		plataforma.recomendarFilme(filme1, "Filme sensacional. Você precisa assistir!", usuario1, usuario2);
		plataforma.recomendarFilme(filme2, "Filme Top. Recomendo você assistir!", usuario2, usuario2);
		plataforma.recomendarFilme(filme3, "Filme Incrível. Tenho certeza que você vai curtir!", usuario10, usuario2);
		...
		System.out.println("+ " + plataforma.indicarFilmeCatalogo("Tá Dando Onda", usuario2));
		System.out.println("- " + plataforma.indicarFilmeCatalogo("Viva - A vida é uma festa", usuario1));

		System.out.println("\nSugestões de filmes da plataforma: ");
		int aux = 1;
		...
		System.out.println("\nGENEROS MAIS ASSISTIDO DO USUÁRIO " + usuario6.getNome().toUpperCase());
