...
public class UnindoTodosPontos1 {
	...
	public static void main(String[] args) {
		...
		Filme filme1 = new Filme("O Rei Leão", "Simba, um leão herdeiro do trono, "
				+ "precisará enfrentar seu tio Scar e escapar de suas artimanhas "
				+ "para evitar perder seu posto como futuro rei.", GeneroFilme.ANIMACAO, 
				"https://devinflix.com.br/oreileao");
		
		filmes.add(filme1);
		
		Filme filme2 = new Filme("Forrest Gump - O Contador de Histórias", "Quarenta anos "
				+ "da história dos Estados Unidos, vistos pelos olhos de Forrest Gump "
				...
				+ "de infância, Jenny Curran.", GeneroFilme.DRAMA, 
				"https://devinflix.com.br/forrestgump");
		
		filmes.add(filme2);
		
		Filme filme3 = new Filme("Vingadores: Ultimato", "Os Vingadores unem forças para "
				+ "lutar contra Thanos, após o vilão eliminar metade dos seres vivos da "
				+ "galáxia.", GeneroFilme.FANTASIA, 
				"https://devinflix.com.br/vingadoresultimato");
		
		filmes.add(filme3);
		
		Filme filme4 = new Filme("À Espera de um Milagre", "1935, no corredor da morte de "
		...
		Filme filme5 = new Filme("Star Wars: O Império Contra-ataca", "As forças imperais "
				+ "comandadas por Darth Vader lançam um ataque contra os membros da "
		...
		Filme filme6 = new Filme("De Volta para o Futuro", "Um jovem (Michael J. Fox) "
				...
				+ "existência, pois alteraria todo o futuro.", GeneroFilme.FICCAO_CIENTIFICA, 
